            ...
            >
              <thead className="bg-gray-50">
                <tr>
                  <th
                    scope="col"
                    className="sticky max-w-[200px] top-0 z-10 border-b border-gray-300 bg-gray-50 bg-opacity-75 py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8"
                  >
                    Name
                  </th>
                  <th
