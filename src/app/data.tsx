...
export const Resources: Resource[] = [
  ...
  {
    name: "Against Against Intellectual Property: a Short Refutation of Meme Communism",
    authors: ["J. C. Lester"],
    type: ResourceType.article,
    description:
      "This essay is intended to be a refutation of the main thesis in Against Intellectual Property, Kinsella 2008 (hereafter, K8).",
    href: "https://philarchive.org/rec/LESAAI",
  },
];
...
export const People = {
  ...
  "Sarah Fitz-Claridge": {
    name: "Sarah Fitz-Claridge",
    description:
      "Sarah Fitz-Claridge is a writer, editor, and speaker with interests in philosophy, psychology, self-development, freedom, and other topics related to living a fulfilling life. She founded Taking Children Seriously in the 1990s and is currently writing a book on the subject.",
    websiteURL: "https://www.fitz-claridge.com/",
    twitterURL: "https://twitter.com/FitzClaridge",
  } as PeopleTypes,
  "Peter Medawar": {
    name: "Peter Medawar",
    description:
  ...
  "J. C. Lester": {
    name: "J. C. Lester",
    description:
      "J. C. Lester is a philosopher and author of Escape From Leviathan and other books.",
    websiteURL: "https://philpeople.org/profiles/jan-clifford-lester",
    twitterURL: "https://twitter.com/JCLester",
  } as PeopleTypes,
  "Ella Hoeppner": {
    name: "Ella Hoeppner",
    description:
